...
TernausNet is a modification of the celebrated UNet
architecture with VGG as encoder that is widely used for binary Image Segmentation.
"""
...
class UNet11(nn.Module):
    def __init__(self, n_classes: int = 1,  num_filters: int = 32, pretrained: bool = False) -> None:
        """
        Args:
            num_filters:
            pretrained:
        ...
        self.final = nn.Conv2d(num_filters, self.n_classes, kernel_size=1)
